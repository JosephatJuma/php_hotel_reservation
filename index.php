...
<head>
    ...
    <title>Rev Titus Baraka guest house.</title>
</head>
    ...
    <section id="auth_section">
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                ?>
                <form class="user_login authsection active" id="userlogin" action="index.php" method="POST">
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="index.php" method="POST">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="Username" placeholder=" ">
                        <label for="Username">Username</label>
                    </div>
