...
<body>
	...
	if ($bed == "Single") {
		$type_of_bed = $type_of_room * 1 / 50;
	} else if ($bed == "Double") {
	} else if ($bed == "Triple") {
		$type_of_bed = $type_of_room * 3 / 50;
	} else if ($bed == "Quad") {
		$type_of_bed = $type_of_room * 4 / 50;
	} else if ($bed == "None") {
		$type_of_bed = $type_of_room * 0 / 50;
	}
	...
	<header>
		<h1>Invoice</h1>
		<address>
			<p>Rev Titus Baraka guest house,</p>
			<p>0752627193</p>
			<p>Send your payments via account number in stanbic or mobile money</p>
			<p>A/C NO 90300879872, A/C NAME kobusingye Dianah OR 0752627193 same name</p>
			<p>confirm your payment before you check in</p>
		</address>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- dianah@gmail.com || Web :- www.RevTitusBarakaguesthouse.com || Phone :- O752627193 </p>
		</div>
	</aside>
